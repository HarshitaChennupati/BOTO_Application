...
public class AddEmployee_Page extends Driver_Page{
	private final static By byAdd=By.cssSelector("//span[text()='Add']");	
	...
	private final static By byDOJ=By.xpath("//input[@class='form-control ng-pristine ng-invalid ng-touched']");
	...
	{
		ClickOnEmployee().sendKeys("0001");;
	}
	public static void ClickOnMemberId()
	{
		ClickOnMember().sendKeys("0001A");;
	}
	...
	{
		ClickOnMail().sendKeys("abhi10@yopmail.com");
	}
	public static void ClickOnMobileNumber()
	{
		CLickOnMobile().sendKeys("9888675906");
	}
