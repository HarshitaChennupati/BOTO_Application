...
public class UserHome_Page extends Driver_Page{
 private final static By bypremiumcard=By.xpath("//h5[text()=' Premium ']");
 private final static By bypremiumview=By.xpath("//td[text()='View']");
 private final static By byclaimscard=By.xpath("//h5[text()=' Claims ']");
 private final static By byclaimview=By.xpath("//td[text()='View']");
 private final static By byendorsementcard=By.xpath("//h5[text()=' Endorsement']");
